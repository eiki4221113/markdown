...
日本国民は、国ウェブ関連技術の標準化は [World Wide Web Consortium (W3C)](http://www.w3.org/) などによって行われています。
家の名誉にかけ、全力をあげてこの崇高な理想と目的を達成することを誓ふ。
...
public static void main(string[]){
    system.out.printlen("Hello ikezaki");
}
```
# 水平線
***
